...
const TREATMENTS = [
  ...
  },
  {
    ...
    subtitle: 'Reshape and brighten teeth with resin',
  ...
  {
    id: 'gum', label: 'Gum disease treatment',
    subtitle: 'Periodontal care and gum health',
  ...
  },
  {
    ...
    subtitle: 'Gentle, friendly care for young patients',
    color: '#fffbeb', iconColor: '#d97706',
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden>
