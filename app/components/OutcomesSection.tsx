const outcomes = [
  ...
  },
  {
    ...
    icon: <svg key={1} width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#34d399" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8" /><line x1="21" y1="21" x2="16.65" y2="16.65" /></svg>,
  },
  {
    title: 'Improve treatment conversion',
    body: 'Understand the feedback patterns that drive treatment acceptance — and the friction points that cause patients to hesitate or drop off.',
    icon: <svg key={2} width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#34d399" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18" /><polyline points="17 6 23 6 23 12" /></svg>,
  },
  {
    title: 'Monitor reputation trends',
    body: 'Track how patient sentiment shifts over time — across clinical dimensions and locations — so you can act before trends affect your practice\'s reputation.',
    icon: <svg key={3} width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#34d399" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="20" x2="18" y2="10" /><line x1="12" y1="20" x2="12" y2="4" /><line x1="6" y1="20" x2="6" y2="14" /></svg>,
  },
];
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', maxWidth: 540, margin: '0 auto 52px' }}>
          ...
          <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(28px, 3.2vw, 40px)', fontWeight: 800, color: '#edeef5', lineHeight: 1.1, letterSpacing: '-0.03em', margin: '0 0 14px' }}>
            Built for growing practices and dental groups.
          </h2>
