...
export default function ReviewCTA({ href = '/auth/signup' }: Props) {
  return (
    <section className="mx-auto px-5 py-6" style={{ maxWidth: 1200 }}>
      ...
      >
        ...
        <div className="relative" style={{ maxWidth: 520 }}>
          ...
          >
            Help millions find a dentist they trust
          </h2>
          <p
            style={{
          ...
          >
            Share your last appointment on SmileProof — honest reviews keep practices accountable and help neighbours find the right care.
          </p>
        </div>
